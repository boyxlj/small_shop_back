...
//-----------标签
//获取标签数据  get   /back/tags
export const tagList = ()=>Axios.get("/back/tags")

//添加标签  post   /back/add/tag
export const addTag = (name)=>Axios.post("/back/add/tag",{name})

//修改标签  post   /back/update/tag
export const updateTag= (id,name)=>Axios.post("/back/update/tag",{id,name})

//删除标签  post   /back/delete/tag
export const deleteTag = (id)=>Axios.post("/back/delete/tag",{id})
