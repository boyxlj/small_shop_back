...
export default [
  ...
  {path:"/",element:<Suspense fallback={<p></p>}><Authorization><Navigate to="welcome" /></Authorization></Suspense>},
  {path:"/welcome",element:LazyLoad("welcome",false)},
  {path:"/user",element:LazyLoad("user",false)},
  {path:"/swiper",element:LazyLoad("swiper",false)},
  {path:"/details",element:LazyLoad("details",false)},
  {path:"/category",element:LazyLoad("category",false)},
  {path:"/shop",element:LazyLoad("shop",false)},
  {path:"/editor",element:LazyLoad("editor",false)},
  {path:"/order",element:LazyLoad("order",false)},
