...
export default function ShopTable(props) {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: 'prePrice',
      render:(value)=>{
       return value!=='null'?<Tag color="geekblue">{value}元</Tag>:<Tag color="geekblue">未标注原价</Tag>
      }
    },
    {
      title: '现价',
    ...
    },
    {
      ...
      dataIndex: 'tag',
      render:(value)=>{
       return value!=='null'?<Tag color="geekblue">{value}</Tag>:<Tag color="geekblue">/123</Tag>
      }
    },
    {
      title: '上架时间',
